          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[1, 2, 3].map((i) => (
              <Card key={i}>
                ...
                <CardContent>
                  <CardTitle className="mb-2">Featured Article Title {i}</CardTitle>
                  <p className="text-gray-600 mb-4">
                    A brief description of the featured article to give readers an idea of its content.
                  </p>
                </CardContent>
                <CardFooter>
